#!/bin/sh
sd_dir="/run/media/mmcblk0p1"
mmc_dir="/run/media/mmcblk3p1"
zImage_file="/run/media/mmcblk0p1/UPDATE/zImage"
imx6q_sabresd_file="/run/media/mmcblk0p1/UPDATE/imx6q-sabresd.dtb"
sf_file="/run/media/mmcblk0p1/UPDATE/V*-*.tar.bz2"
app_file="/run/media/mmcblk0p1/UPDATE/t6a_app"
local_app_file="/home/chinagps/t6a_app"
version_path="/home/tsh/1_tianshuang/version.txt"
UPDATE_path="/run/media/mmcblk0p1/UPDATE/"
update_time_path="/home/chinagps/update_time.txt"
uboot_file="/run/media/mmcblk0p1/UPDATE/u-boot.imx"
msg_info="/run/media/mmcblk0p1/UPDATE/msg_info.bmp"
shell_file="/run/media/mmcblk0p1/UPDATE/auto_run.sh"
need_reboot=0
need_show=0
if [ -d "$sd_dir" ]
then
...
echo "not check sd card"
/home/chinagps/t6a_update_by_usb.sh &
exit 0
fi
...
echo "$ver2"                  
ver3=$(ls /run/media/mmcblk0p1/UPDATE/V*-*.tar.bz2)
echo "$ver3"
if [ -n "$ver3" ]       
then      
if [ "$ver2" = "$ver3" ]
