...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/qt5/Enginio/1.2.1"
        "${_qt5Enginio_install_prefix}/include/qt5/Enginio/1.2.1/Enginio"
    )
    ...
    macro(_populate_Enginio_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Enginio_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Enginio_check_file_exists(${imported_location})
