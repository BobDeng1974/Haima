...
if (NOT TARGET Qt5::PublishSubscribe)
    ...
    set(_Qt5PublishSubscribe_OWN_INCLUDE_DIRS "${_qt5PublishSubscribe_install_prefix}/include/qt5/" "${_qt5PublishSubscribe_install_prefix}/include/qt5/QtPublishSubscribe")
    set(Qt5PublishSubscribe_PRIVATE_INCLUDE_DIRS
        "${_qt5PublishSubscribe_install_prefix}/include/qt5/QtPublishSubscribe/5.4.0"
        "${_qt5PublishSubscribe_install_prefix}/include/qt5/QtPublishSubscribe/5.4.0/QtPublishSubscribe"
    )
    ...
    macro(_populate_PublishSubscribe_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5PublishSubscribe_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_PublishSubscribe_check_file_exists(${imported_location})
