...
get_filename_component(_realOrig "/usr/lib/cmake/Qt53DCollision" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt53DCollision_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::3DCollision)
    ...
    set(_Qt53DCollision_OWN_INCLUDE_DIRS "${_qt53DCollision_install_prefix}/include/qt5/" "${_qt53DCollision_install_prefix}/include/qt5/Qt3DCollision")
    set(Qt53DCollision_PRIVATE_INCLUDE_DIRS
        "${_qt53DCollision_install_prefix}/include/qt5/Qt3DCollision/5.5.1"
        "${_qt53DCollision_install_prefix}/include/qt5/Qt3DCollision/5.5.1/Qt3DCollision"
    )
    ...
    macro(_populate_3DCollision_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt53DCollision_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DCollision_check_file_exists(${imported_location})
