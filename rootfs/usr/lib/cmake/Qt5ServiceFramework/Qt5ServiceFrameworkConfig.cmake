...
if (NOT TARGET Qt5::ServiceFramework)
    ...
    set(_Qt5ServiceFramework_OWN_INCLUDE_DIRS "${_qt5ServiceFramework_install_prefix}/include/qt5/" "${_qt5ServiceFramework_install_prefix}/include/qt5/QtServiceFramework")
    set(Qt5ServiceFramework_PRIVATE_INCLUDE_DIRS
        "${_qt5ServiceFramework_install_prefix}/include/qt5/QtServiceFramework/5.4.0"
        "${_qt5ServiceFramework_install_prefix}/include/qt5/QtServiceFramework/5.4.0/QtServiceFramework"
    )
    ...
    macro(_populate_ServiceFramework_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5ServiceFramework_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_ServiceFramework_check_file_exists(${imported_location})
